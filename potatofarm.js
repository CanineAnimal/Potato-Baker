...
var func3 = function(){
  ...
  bbCode3 = bbCode2.replaceAll('"', '%22');
  document.body.innerHTML = '<A HREF="https://www.nationstates.net/page=compose_telegram?tgto=region:the_north_pacific%20%252Btag:wa&message=' + bbCode3 + '">Manual link to send telegram.</A>';
}
