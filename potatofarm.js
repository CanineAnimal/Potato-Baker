...
var func3 = function(){
  ...
  document.body.innerHTML = '<A HREF="https://www.nationstates.net/page=compose_telegram?tgto=region:the_north_pacific,%2Btag:wa,-nation:plembobria,-nation:votak_matim,-nation:zazumo,-nation:comfed,-nation:waupun_island,-nation:magecastle_embassy_building_a5,-nation:francois_isidore,-nation:minuda&message=' + bbCode3 + '">Manual link to send telegram.</A>';
}
